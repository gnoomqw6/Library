...
<div class="content">
    ...
    <% if (request.getParameter("reg") != null && !request.getParameter("reg").isEmpty()) { %>
        <h2>Вы успешно зарегистрировались и стали участником нашей <a href="#">дисконтной программы</a>!</h2>
    <% } else { %>
